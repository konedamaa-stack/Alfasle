...
export const initialEtablissements: Etablissement[] = [
  {
    ...
    directorName: "Dr. Karim Belkacem",
    directorEmail: "karim.belkacem@alfasle.edu",
    status: "ACTIVE",
  ...
  {
    id: "etab_raya1",
    name: "Groupe Scolaire & Institut Raya 1",
    code: "ALF-RAY-01",
    subdomain: "raya1",
    type: "LYCEE",
    city: "Abidjan",
    country: "Côte d'Ivoire",
    address: "Cocody Riviera, Boulevard Mitterrand",
    phone: "+225 07 11 22 33",
    email: "direction@raya1.alfasle.xyz",
    description: "Établissement d'excellence et d'innovation pédagogique avec suivi numérique et cours interactifs.",
    logoUrl: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=150&auto=format&fit=crop&q=80",
    coverImage: "https://images.unsplash.com/photo-1562774053-701939374585?w=800&auto=format&fit=crop&q=80",
  ...
  {
    id: "etab_dar_alarqam",
    name: "Groupe Scolaire & Institut Dar Al-Arqam",
    code: "ALF-ARQ-01",
    subdomain: "alarqam",
    type: "LYCEE",
    city: "Abidjan",
    ...
    email: "direction@alarqam.alfasle.edu",
    description: "Groupe scolaire et institut d'enseignement général et technologique d'excellence.",
    logoUrl: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=150&auto=format&fit=crop&q=80",
    coverImage: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800&auto=format&fit=crop&q=80",
    directorName: "Djibril",
    directorEmail: "djibril@alarqam.alfasle.edu",
    status: "ACTIVE",
    subscriptionPlan: "ENTERPRISE",
    maxStudentsQuota: 1200,
    maxClassesQuota: 40,
    classesCount: 2,
    studentsCount: 50,
    createdAt: "2025-01-01T08:00:00Z",
...
export const initialUsers: User[] = [
  ...
  },
  {
    ...
    username: "djibril",
    email: "djibril@alarqam.alfasle.edu",
    password: "123",
    role: "ADMIN",
    bio: "Directeur & Administrateur Principal du Groupe Scolaire Dar Al-Arqam.",
  ...
  },
  {
    id: "u_admin_raya1",
    name: "Admin Raya 1",
    username: "admin.raya1",
    email: "admin.raya1@alfasle.xyz",
    password: "Madouu1966@",
    role: "ADMIN",
    bio: "Directeur & Administrateur du Groupe Scolaire & Institut Raya 1.",
    avatarUrl: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80",
    etablissementId: "etab_raya1",
    etablissementName: "Groupe Scolaire & Institut Raya 1",
    createdAt: "2025-01-01T08:00:00Z",
  },
  {
    id: "u_admin_1",
...
export const initialClasses: Classe[] = [
  ...
  {
    id: "cls_raya_info_101",
    classCode: "AF-RAY-101",
    etablissementId: "etab_raya1",
    etablissementName: "Groupe Scolaire & Institut Raya 1",
    title: "Tronc Commun & Informatique Appliquée - Raya 1",
    description: "Classe principale de l'établissement Raya 1. Cours interactifs, devoirs et suivi des étudiants.",
    level: "Tous Niveaux",
  ...
  {
    id: "cls_arqam_101",
    classCode: "AF-ARQ-101",
    etablissementId: "etab_dar_alarqam",
    etablissementName: "Groupe Scolaire & Institut Dar Al-Arqam",
    title: "Classe Générale & Sciences - Dar Al-Arqam",
    description: "Classe de référence pour les enseignements généraux, scientifiques et technologiques.",
    level: "Secondaire / Lycée",
    category: "Général & Sciences",
    capacity: 35,
    enrollmentMode: "OPEN",
    status: "ACTIVE",
    teacherId: "u_teacher_1",
...
export const initialInscriptions: Inscription[] = [
  ...
  },
  {
    ...
    userPhone: "+213 66 78 90 12",
    userAvatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&auto=format&fit=crop&q=80",
    role: "STUDENT",
    etablissementId: "etab_dar_alarqam",
    etablissementName: "Groupe Scolaire & Institut Dar Al-Arqam",
    classeId: "cls_arqam_101",
    classeTitle: "Classe Générale & Sciences - Dar Al-Arqam",
    status: "PENDING",
    motivation: "Après 2 ans d'études, je souhaite m'inscrire dans l'institut Dar Al-Arqam pour suivre le cursus scientifique.",
  ...
  },
  {
    ...
    userPhone: "+213 77 45 67 89",
    userAvatar: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?w=150&auto=format&fit=crop&q=80",
    role: "STUDENT",
    etablissementId: "etab_raya1",
    etablissementName: "Groupe Scolaire & Institut Raya 1",
    classeId: "cls_raya_info_101",
    classeTitle: "Tronc Commun & Informatique Appliquée - Raya 1",
    status: "PENDING",
    motivation: "Très motivé pour intégrer la classe Raya 1 et suivre les cours interactifs.",
    appliedAt: "2026-09-03T16:05:00Z",
  },
  {
    id: "ins_teacher_cand_1",
    userName: "Dr. Oumar Sangaré",
    userEmail: "oumar.sangare@gmail.com",
    userPhone: "+225 05 99 88 77",
    userAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
    role: "TEACHER",
    etablissementId: "etab_dar_alarqam",
    etablissementName: "Groupe Scolaire & Institut Dar Al-Arqam",
    ...
    diplomaOrBio: "Doctorat en Sciences Physiques, 10 ans d'enseignement en lycée et classes préparatoires.",
    status: "PENDING",
    motivation: "Candidature pour dispenser les cours de physique-chimie et travaux dirigés à l'institut Dar Al-Arqam.",
    appliedAt: "2026-09-04T08:30:00Z",
  },
  {
    id: "ins_teacher_cand_2",
    userName: "Mme Aïcha Touré",
    userEmail: "aicha.toure@educ.ci",
    userPhone: "+225 07 44 33 22",
    ...
    diplomaOrBio: "Master en Génie Logiciel, certifiée en pédagogie numérique.",
    status: "PENDING",
    motivation: "Souhaite rejoindre l'équipe enseignante de Raya 1 pour animer les cours d'informatique appliquée.",
    appliedAt: "2026-09-05T14:15:00Z",
  },
];
